    ...
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            To provide you with personalised community recommendations, we need your consent to:
          </DialogDescription>
        </DialogHeader>
        ...
        <p className="text-xs text-muted-foreground">
          You can withdraw consent and delete your data at any time from Settings.
